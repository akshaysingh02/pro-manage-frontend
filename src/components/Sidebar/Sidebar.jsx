    ...
    <>
      <div className={styles.sidebar}>
        ...
        <div className={styles.buttonsWrapper}>
          <button
            className={`${styles.sidebarNavButton} ${
              selectedSection === "board" ? styles.activeButton : ""
            }`}
          ...
          <button
            className={`${styles.sidebarNavButton} ${
              selectedSection === "analytics" ? styles.activeButton : ""
            }`}
          ...
          <button
            className={`${styles.sidebarNavButton} ${
              selectedSection === "settings" ? styles.activeButton : ""
            }`}
        ...
        <div className={styles.logoutWrapper}>
          <div className={styles.logoutButton} onClick={openModal}>
            <img src={logoutLogo} alt="" /> <span>Log out</span>
          </div>
        </div>
      </div>
      {isModalOpen && <LogoutModal closeModal={closeModal} handleLogOut={handleLogOut} />}
    </>
  );
}
